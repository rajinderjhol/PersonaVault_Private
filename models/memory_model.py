...
# Import the shared Base and SessionLocal factory from the app's central session module
...
class Memory(Base):
    ...
    query = Column(Text)  # The query that generated this memory
    ...
    def __init__(self, user_id, content, memory_type, query=None, tags=None, privacy_level="public", expiry_days=7):
        """
        ...
        :param query: The query that generated this memory.
